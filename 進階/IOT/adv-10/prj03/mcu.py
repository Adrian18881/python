...
class MQTT:
    def __init__(self, mqttClientId, mq_server, mqtt_username, mqtt_password, keepalive = 30):
        self.mq_server = mq_server
        self.mqttClientId = mqttClientId
        self.mqtt_username = mqtt_username
        self.mqtt_password = mqtt_password
        self.mqClient0 = MQTTClient(mqttClientId, mq_server, user=mqtt_username, password = mqtt_password, keepalive = 30)
