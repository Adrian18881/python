...
for h in range(150):
    ...
    x_shift = random.randint(-1, 1)  #x 軸 偏移量
...
while True:
    ...
    if paint:
        ...
        pygame.mixer.music.unpause()  #下雪時波音樂，並顯示start
        snow_fall()
    else:
        title = font.render("Stop", True, BLACK)
        pygame.mixer.music.pause()  #不下雪時不波音樂，並顯示stop
